...
const DEMONSLAYER_AU: Character[] = [
  ...
  { id: 1406, characterName: "Ranpo Edogawa", variant: "Logic Breather", displayName: "Ranpo", description: "Logic Breathing is not a real form — he made it up and it somehow works better than all the recognized styles. He deduces exactly where a demon will move three seconds before they do it.", ability: "Ultra Deduction", faction: "ADA", element: "Logic", rarity: "SR", hp: 7800, atk: 3600, def: 2600, skill: "Logic Breathing: Final Form", skillDescription: "Perfect deduction — reads the demon's next 3 moves. Dodge all enemy attacks this turn + counter.", gradient: "from-yellow-600 to-amber-700", emoji: "🍬", imageUrl: "https://placehold.co/150x240/b45309/ffffff?text=Ranpo+%28Logic%29", banner: "demonslayer", au: "Demon Slayer AU" },
  { id: 1407, characterName: "Kunikida Doppo", variant: "Wind Hashira", displayName: "Kunikida", description: "Wind Breathing suits him perfectly — it is forceful, principled, and does not accommodate deviations from its ideal form. His Ideal notebook generates replacement blades in real-time.", ability: "Lone Poet", faction: "ADA", element: "Strength", rarity: "SSR", hp: 10400, atk: 4800, def: 3600, skill: "Wind Breathing: Eighth Form", skillDescription: "Tornado Slash — eight consecutive strikes. Each hit deals 60% ATK. Ignores 30% DEF.", gradient: "from-emerald-700 to-teal-900", emoji: "🌪️", imageUrl: "https://placehold.co/150x240/065f46/ffffff?text=Kunikida+%28Wind%29", banner: "demonslayer", au: "Demon Slayer AU" },
  { id: 1408, characterName: "Sigma", variant: "Upper Moon Six", displayName: "Sigma", description: "He became an Upper Moon by accident — nobody warned him that inheriting a Blood Demon Art from a defeated demon counted. His art manipulates perception of debt and memory. He is still reading the Demon Slayer Corps rulebook.", ability: "The Book", faction: "Rats", element: "Logic", rarity: "SR", hp: 9200, atk: 3800, def: 3200, skill: "Memory Rewrite", skillDescription: "Overwrites enemy's combat memory — enemy forgets all buffed stats this battle. Reset to base.", gradient: "from-slate-700 to-indigo-900", emoji: "📖", imageUrl: "https://placehold.co/150x240/334155/ffffff?text=Sigma+%28Upper+Moon%29", banner: "demonslayer", au: "Demon Slayer AU" },
];
...
export const BANNERS: Banner[] = [
  ...
  },
  {
    ...
    limited: true,
    startDate: "November 26, 2026",
    endDate: "December 10, 2026",
    emoji: "🦸",
  ...
  },
  {
    ...
    description: "2 URs! Hashira Chuuya + Demon Lord Fyodor debut alongside 6 more exclusives.",
...
export const ACHIEVEMENTS = [
  ...
  { id: 6, title: "Pomodoro Pro", description: "Complete 25 Pomodoro sessions", icon: "⏱️", earned: false, xp: 400 },
